...
The app is already deployed so you can play around with the final product using this
...
![Sorting Visualizer - regular (light) mode](https://i.imgur.com/wYIircd.png)

The app has a switch for turning on .

![Sorting Visualizer - ](https://i.imgur.com/HwwiX7X.png)
